...
source: description of a non-website source
sourceurl: url to source for recipe
pdf: name of pdf index card created for this recipe (stored in static/pdf/name)
pdfhand: name of pdf index card from which this recipe was copied
---
